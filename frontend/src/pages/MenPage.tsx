...
export const MenPage: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    setError(null);
    try {
      const data = await api.getProductsByGender('men');
      setProducts(data);
    } catch {
    ...
    <div className="py-10 md:py-14 space-y-8">
      <PageContainer>
        ...
        <SectionHeading
          ...
          title="Menswear, refined"
          subtitle="Structured raw silk bandhgalas, tailored linen shirts, hand-spun khadi kurtas, and Japanese selvedge denim."
          align="center"
        />
